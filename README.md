...
* For the first input series, the prometheus timesies returns an `empty query result` for 20 minutes (20 x interval), then it is returning the value `1` for 20 minutes. Finally, it is returning the value `0` for 20 minutes.
